...
function open_wsdl(uri, options, callback) {
  ...
  } else if (uri === 'http://www.w3.org/TR/xmldsig-core/xmldsig-core-schema.xsd'){

    uri = 'https://www.w3.org/TR/2008/REC-xmldsig-core-20080610/xmldsig-core-schema.xsd';
    var httpClient2 = options.httpClient || new HttpClient(options);
    httpClient2.request(uri, null /* options */, function(err, response, definition) {
      if (err) {
        callback(err);
